...
const Blog = () => {
  return (
    <div className='blogBigMain'>
      <h1 className='blogHeaderMain'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean diam nunc, commodo.</h1>
      <div className='blogSearchBar'>
        <div className='placeholderBlog'>
            <img src={search} className='blogSearch'/>
            <input placeholder='Search posts, tags and authors' className='blogText'/>
        </div>
