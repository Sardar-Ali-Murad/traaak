       ...
       <div className="homeHeaderMain">
        ...
        <div className='productHeaderGrid'>
            <div className='productContent'>
                ...
                <p>Customer portfolio management platform for success, account management, relationship management, customer service teams. Keep track of your customer activities, stay organised and never miss what is important. </p>
