...
let compare=[
  {
    ...
    img:c1,
    content:["Often sales focused ","Can be complex","Difficult to master","Data overload "]
  },
  {
    head:"Traaak",
    img:c2,
    content:["Simple and user friendly","Task focused","Easy to learn","Basic yet practical"]
  },
  {
    head:"Typical Task Application",
    img:c1,
    content:["Generic in nature ","Usually doesn’t allow for customer portfolio mapping","Too simple or too complex"]
  },
]
...
let UseData=[
  ...
  },
  {
    ...
    points:["Customer service teams","Relationship teams","Existing CRM is not post-sale focused.","Managing some customer or work-related tasks with spreadsheets","Ability to integrate to integrate existing platforms."]
  },
  {
    head:"Small Startup",
    points:["Customer success teams","Relationship management teams","Account management teams","Existing CRM is not post-sale focused focused ","Managing customer activity on multiple platforms","Managing some customer or work-related tasks with spreadsheets","Ability to integrate existing platforms."]
  },{
    head:"Medium Startup",
    points:["Customer success teams","Relationship management teams","Account management teams","Client service teams","Existing CRM is not post-sale focused","Managing few customers or work-related tasks using spreadsheets","Able to integrate existing platforms."]
  }
]
