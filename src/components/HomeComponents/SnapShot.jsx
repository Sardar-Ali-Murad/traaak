      ...
      <div className="snapShopMain">
        ...
        <div className="snapShotContent">
          ...
          <p className="homePara">
            Get a bird’s eye view of customer records and ongoing work from. How
            many customers are currently on your portfolio, number of customers
            in each customer lifecycle stage, number of active vs competed
            tasks, assigned and received tasks over a specific period. This
